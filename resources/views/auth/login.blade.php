                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="p-5">
                            <div class="text-center">
                                <img src="{{asset('images/logo-kpu.png')}}">
                            ...
                            <form class="user" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control @error('password') is-invalid @enderror form-control-user" name="password" required autocomplete="current-password" id="exampleInputPassword" placeholder="Password">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
